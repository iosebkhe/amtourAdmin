...
export default function ProductForm({
  ...
  return (
    <form onSubmit={saveProduct}>
      <label className="mb-3 inline-block">ტურის სახელი</label>
      <input
        type="text"
      ...
      <label className="mb-3 inline-block">მთავარი ფოტო</label>
      ...
      <div>
        <label className="mb-3 inline-block">ტურის აღწერა აღწერა</label>
        <ReactQuill
